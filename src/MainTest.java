...
public class MainTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n========================================");
        System.out.println("? 代理服务器已启动，监听端口: 8080");
        System.out.println("? 系统代理已自动设置为 127.0.0.1:8080");
        System.out.println("========================================");
        System.out.println("\n【测试内容】");
        System.out.println("  1. 访问正常网站 → 应正常打开，记录到数据库");
        System.out.println("  2. 访问黑名单网站 → 应显示拦截页面");
        System.out.println("\n【查看记录】");
        System.out.println("  在 VS Code 中查询: SELECT * FROM WebHistory ORDER BY VisitTime DESC");
        System.out.println("\n========================================\n");
